...
@section('title', "Edit Work Order #{$workOrder->id} - TPAS Work Form")
...
<div class="mb-6">
    ...
    <p class="text-gray-600">Edit informasi work order ini</p>
</div>

<div class="max-w-2xl">
    <form method="POST" action="{{ route('work-orders.update', $workOrder->id) }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 divide-y divide-gray-100">
        @csrf
        @method('PUT')
        ...
        <div class="p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" id="location_city" name="location_city" value="{{ old('location_city', $workOrder->location_city) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="location_district" name="location_district" value="{{ old('location_district', $workOrder->location_district) }}" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none">
                ...
                <div>
                    ...
                    <input type="text" id="location_village" name="location_village" value="{{ old('location_village', $workOrder->location_village) }}" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none">
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" id="work_date" name="work_date" value="{{ old('work_date', $workOrder->work_date->format('Y-m-d')) }}" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none">
                ...
                <div>
                    ...
                    <input type="time" id="start_time" name="start_time" value="{{ old('start_time', $workOrder->start_time->format('H:i')) }}" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea id="activity_details" name="activity_details" rows="4" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none resize-none">{{ old('activity_details', $workOrder->activity_details) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" id="site_pic" name="site_pic" value="{{ old('site_pic', $workOrder->site_pic) }}" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none">
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="2"
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none resize-none">{{ old('notes', $workOrder->notes) }}</textarea>
